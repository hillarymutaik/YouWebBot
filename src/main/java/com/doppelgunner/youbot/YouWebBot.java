 ...
 */
public class YouWebBot extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("YouWebBot - YouTube Commenter");
        ...
        loginStage.getIcons().add(new Image("/images/logo.jpg"));
    ...
    public static FXMLLoader createLoader(String filepath) {
        URL url = YouWebBot.class.getResource(filepath);
